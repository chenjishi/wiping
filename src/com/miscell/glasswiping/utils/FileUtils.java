...
public class FileUtils {
    ...
    public static String getImageCacheSize(Context context) {
        String cachePath = DirectoryUtils.getCacheDirectory(context);
    ...
    public static void clearCache(Context context) {
        //clear images
        NetworkRequest.getRequestQueue().getCache().clear();

        //clear data
        String dataCacheDir = DirectoryUtils.getCacheDirectory(context);
